...
//2.Randomising opinions
var randomiser = function(array){
  return array[Math.floor(Math.random() * array.length)];

};
//3. Pushing random opinions
function pushTenTimes(randomiser, array){
   return _.times(10, function(){return randomiser(array)});
}

//4. Pushing five times the array of ten:
function pushFiveTimesTheTenTimesAlreadyPushed(randomiser, array){
   return _.times(5, function(){return pushTenTimes(randomiser, opinions)});
}

//5. Returning the results
pushFiveTimesTheTenTimesAlreadyPushed(randomiser,opinions);
...
function addMissingNamesToNewArray(birthdayPair,moreBirthdays){
  return _.concat(birthdayPair,_.chunk(moreBirthdays,2));
}

addMissingNamesToNewArray(birthdayPair,moreBirthdays);
...
var noRepeatChar = function (password) {
  var uniqueOrNot = password.split("");
  var unique =_.union(password.split(""));
    if (uniqueOrNot.toString() !== unique.toString()) {
      console.log("wrong password");
   } else {
      console.log("Wow great password!");
  }
};
...
var trimPassword = function (password) {
  return  _.slice(password.split(""), 0, 10);
}
